  ...
  function renderNav(role, activePage) {
    if (role === 'Owner') {
      ...
      const items = [
        ...
        { pane: 'risk', label: 'Risk Watchlist', icon: '<path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>' },
        { pane: 'broadcast', label: 'Broadcast & Exports', icon: '<path d="M4 11v2"/><path d="M10 6.5 21 3v18L10 17.5"/><path d="M10 6.5v11"/><path d="M4 11c0-2.5 2-4.5 4.5-4.5H10v9H8.5C6 15.5 4 13.5 4 11z"/>' },
      ];
      nav.innerHTML = `
